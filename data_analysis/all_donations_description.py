...
#%%
diretas_pj = corruptos_brasil[(corruptos_brasil[u'id_original_donator_cpf_cnpj'].isnull()) 
                           & (corruptos_brasil[u'id_donator_cpf_cnpj'].astype(str).apply(lambda x: len(x)) == 14)]
...
#%%
diretas_pf = corruptos_brasil[(corruptos_brasil[u'id_original_donator_cpf_cnpj'].isnull()) 
                           & (corruptos_brasil[u'id_donator_cpf_cnpj'].astype(str).apply(lambda x: len(x)) == 11)]
...
#%%
indiretas_pj = corruptos_brasil[(corruptos_brasil[u'id_original_donator_cpf_cnpj'].astype(str).apply(lambda x: len(x)) == 14) 
                             & (corruptos_brasil[u'id_donator_cpf_cnpj'].astype(str).apply(lambda x: len(x)) == 14)]
...
#%%
indiretas_pf = corruptos_brasil[(corruptos_brasil[u'id_original_donator_cpf_cnpj'].astype(str).apply(lambda x: len(x)) == 11) 
                             & (corruptos_brasil[u'id_donator_cpf_cnpj'].astype(str).apply(lambda x: len(x)) == 14)]
...
#%%
indiretas_teste = corruptos_brasil[(corruptos_brasil[u'id_original_donator_cpf_cnpj'].isnull() == False) 
                                & (corruptos_brasil[u'id_donator_cpf_cnpj'].astype(str).apply(lambda x: len(x)) == 11)]
...
#%%
unknow = corruptos_brasil[(corruptos_brasil[u'cat_original_donator_name'].isnull()) 
                       & (corruptos_brasil[u'id_donator_cpf_cnpj'].isnull())]
#corruptos_brasil.drop(unknow.index, inplace=True)
