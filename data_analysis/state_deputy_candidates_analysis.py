...
#%%
candidatos_deputado_estadual_indeferidos = pd.read_csv(data_path / 'brazil_2014_state_deputy_candidates_non_accepted.csv', dtype=data_types)
...
#%%
candidatos_deputado_estadual_deferidos = pd.read_csv(data_path / 'brazil_2014_state_deputy_candidates_accepted.csv',  dtype=data_types)
...
#%%
votos_deputados_estaduais_indeferidos = pd.read_csv(data_path / 'brazil_2014_state_deputy_candidates_non_accepted_votes.csv',  dtype=data_types)
...
#%%
votos_deputados_estaduais_deferidos = pd.read_csv(data_path / 'brazil_2014_state_deputy_candidates_accepted_votes.csv',  dtype=data_types)
...
#%%
votacao_candidato_deputado_estadual = pd.read_csv(data_path / "brazil_2014_state_deputy_candidates_accepted_votes_with_candidates_info.csv",  dtype=data_types)
...
deputados_estaduais_corruptos_brasil = pd.read_csv(data_path / 'brazil_2014_state_deputy_candidates_donations_total.csv',  dtype=data_types)
#%%
deputados_estaduais_corruptos_brasil.loc[:,'id_candidate_cpf'] = deputados_estaduais_corruptos_brasil['id_candidate_cpf']
...
#%%
none_donation = votacao_candidato_deputado_estadual[votacao_candidato_deputado_estadual['id_candidate_cpf'].isin(list_doador)==False]
